    def get_progreso(self):
        ...
        print(f"Filtrando áreas con: {filtro_areas}")
        print(f"Áreas encontradas: {areas_configuradas.count()}")
        ...
        if not areas_configuradas.exists():
            ...
            if etapas_totales > 0:
                ...
                return {
                    ...
                    'texto': 'Expediente completo' if porcentaje >= 100 else f'{etapas_completadas}/{etapas_totales} etapas completadas'
                }
        ...
        return {
            ...
            'total': total_areas,
            'texto': f'{areas_con_documentos}/{total_areas} áreas completadas' if porcentaje < 100 else 'Expediente completo'
        }
