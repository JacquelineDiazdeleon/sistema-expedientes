...
from . import views_expedientes, views_expedientes_updated, fixed_views_expedientes, document_views
...
urlpatterns = [
    ...
    # API de documentos por área (para compatibilidad con el frontend existente)
    path('api/documentos/area/<int:area_id>/', 
         views_expedientes_updated.obtener_documentos_por_area, name='api_documentos_area'),
    ...
    path('api/expedientes-por-tipo/', 
         views_expedientes.expedientes_por_tipo, 
         name='api_expedientes_por_tipo'),
    path('api/estadisticas/expedientes-semanales/', 
         views_expedientes.estadisticas_semanales, 
         name='api_estadisticas_semanales'),
    
    # Eliminar documento
    path('documento/<int:documento_id>/eliminar/', 
         views_expedientes.eliminar_documento_area, 
