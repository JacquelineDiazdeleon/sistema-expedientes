...
def reindexar_todos_los_documentos():
    ...
    print(f"Iniciando reindexación de {total} documentos...")
    
    for i, doc in enumerate(documentos, 1):
        try:
            # Primero eliminamos el documento si ya existe en el índice
...
if __name__ == "__main__":
    reindexar_todos_los_documentos()
